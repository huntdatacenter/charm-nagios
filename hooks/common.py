...
HOST_TEMPLATE = "/etc/nagios3-inprogress/conf.d/host_{}.cfg"
HOSTGROUP_TEMPLATE = "/etc/nagios3-inprogress/conf.d/hostgroup_{}.cfg"
...
def refresh_hostgroups():  # noqa:C901
    ...
    for host in hosts:
        ...
        if hgroup_name in hgroups:
            hgroups[hgroup_name].append(host)
        else:
            hgroups[hgroup_name] = [host]
...
def _get_minimal_related_config_paths():
    ...
    if relation_data and (TARGET_ID_KEY in relation_data):
        target_id = relation_data[TARGET_ID_KEY]
